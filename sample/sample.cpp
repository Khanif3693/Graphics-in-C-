//C++ Code for  to draw a 3D structure. 
// Here I have drawn a Gym bar road.
//Since I built this just for fun, I gave this some random colors.
// You can see the output.jpg.
// To run this please make sure you have OpenGL library installed. If not that please downlad 
//the zip file and open the sample.cpp in visual studio.
